...
const Footer: React.FC = () => {
  ...
  const bottomLinks = ['Terms of Service', 'Policy service', 'Cookies Policy', 'Partners']
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="mb-8 lg:hidden">
          ...
          <p className="text-gray-300 text-sm leading-relaxed max-w-md">
            ALX is a platform where travellers can discover and book unique, comfortable, and
            affordable lodging options worldwide. From cozy city apartments and tranquil countryside
            retreats to exotic beachside villas, ALX connects you with the perfect place to stay for
            any trip.
          </p>
        </div>
