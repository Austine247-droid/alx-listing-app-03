    ...
    <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden">
      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-start mb-2">
          <h3 className="font-semibold text-lg text-gray-900 line-clamp-1">{property.name}</h3>
        ...
        <div className="flex justify-between mt-4">
          <div className=" grid grid-cols-3 border w-[156px] rounded-full px-2 py-1">
            <div className="flex items-center">
              ...
              <p className="ml-1 text-[12px] font-medium">{property.offers.bed}</p>
            </div>
            <div className="flex items-center">
              <svg
                width="18"
              ...
              <p className="ml-1 text-[12px] font-medium">{property.offers.shower}</p>
            </div>
            <div className="flex items-center">
              <svg
                width="18"
              ...
              <p className="ml-1 text-[12px] font-medium">{property.offers.occupants}</p>
            </div>
          </div>
